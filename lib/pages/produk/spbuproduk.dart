...
import 'package:maxiaga/pages/produk/pesanan.dart';

class SPBUproduk extends StatefulWidget {
  String nama;
  String alamat;
  SpbuProduct data;
  SPBUproduk({Key key, @required this.nama, this.alamat, this.data})
      : super(key: key);
  @override
          ...
          children: List.generate(widget.data.data.length, (i) {
            return Container(
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        offset: Offset(1, 1), color: Colors.grey, blurRadius: 6)
                  ]),
              child: FlatButton(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Row(
                        ...
                        // crossAxisAlignment: CrossAxisAlignment.center,
                        children: <Widget>[
                       Container(child: FlatButton(child: Icon(Icons.remove_circle,)), width: 50,),
                        Text('0', 
                            textAlign: TextAlign.center,
                          ),
                       Container(child: FlatButton(child: Icon(Icons.add_circle,)), width: 50,),
                          ],
                      ),
                    )
                  ],
