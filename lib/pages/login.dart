...
signIn(String email, pass, Position location)async{
  ...
  var jsonRes = null;
  var res = await http.post("http://maxiaga.com/backend/api/post_login",body: data);
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text("LOGIN untuk Lanjut",style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey
                      // fontWeight: FontWeight.bold,
                    ),),
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: FlatButton(
                          child: Icon(Icons.remove_red_eye, color: obsecureColor,),
                  ...
                  loginGagal == true ? Container(child: Text('Email atau password salah', style: TextStyle(color: Colors.red),),padding: EdgeInsets.only(top: 10),):Text(''),
